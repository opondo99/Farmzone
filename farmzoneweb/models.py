...
class Thread(models.Model):
    '''
    This is the starter for the thread
    Once it has been created  by a user,,
    Other people can comment about it
    '''
    thread_id = models.models.UUIDField(primary_key = True , unique = True , default=uuid.uuid4)
...
class Forum(models.Model):
    '''
    This class create db for the forum messaging details
...
class Chat(models.Model):
    '''
    This is implimentation for the caht table in which a user can comment
    about the product
    '''
